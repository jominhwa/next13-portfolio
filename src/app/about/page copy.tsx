            ...
            <div className="flex flex-wrap justify-center mt-[100px]">
                <div>
                    <p className="relative text-[50px] sm:text-[60px] md:text-[80px] lg:text-[80px] xl:text-[110px] 2xl:text-[110px]">
                        JoMinhwa
                        <span className="absolute right-[-65px] top-[-55px] sm:right-[-70px] sm:top-[-55px] md:right-[-90px] md:top-[-60px] lg:right-[-90px] lg:top-[-60px] xl:right-[-120px] xl:top-[-70px] 2xl:right-[-120px] 2xl:top-[-70px]">
                            <Image
